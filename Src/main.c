...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SPI_CS_Pin|LD3_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_CS_Pin LD3_Pin LD2_Pin */
  GPIO_InitStruct.Pin = SPI_CS_Pin|LD3_Pin|LD2_Pin;
